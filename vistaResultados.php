       ...
       ?><?php if ( $indice == 0){ ?>
          ...
          <tr class="row100">
              ...
              <td class="column100 column1" data-column="column1">
                  <?php
                  if($cont == 1){ ?><center><img style="width:100px;height:100px;" src="images/1.png"></center> <?php }
             
                  if($cont > 1){ ?> <center><b><h1> <?php echo $cont ?>º </h1></b></center> <?php  };
                  $cont++ ;
                  ?>
              </td>
          
           <td class="column100 column1" data-column="column1"><img style="width:100px;height:100px;" src="<?php echo $logo  ?>"><div> <br> <i><?php
           echo $value ?> </i></div></td>
                                    ...
                                    <select name="resultado">
                                     ...
                                     $array= array();
                                         ...
                                         foreach ($_SESSION['resultados'] as $key => $value) {
                                          ...
                                          <?php echo $array['circunscripcion']  ?> - <?php echo $array['fecha']  ?></option><?php
