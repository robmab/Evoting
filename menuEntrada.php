...
<html>
   ...
   echo $_SESSION['nombre'] ?> </td><td class="column100 column2" data-column="column2"> <?php
    echo $_SESSION['apellidos'] ?> </td><td class="column100 column3" data-column="column3"> <?php
              ...
              echo $_SESSION['votante'] ?> </td>
                   ...
                   <tr align="right" ><td rowspan="1" colspan="3">
