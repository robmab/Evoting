...
<script>
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="controladorModificarVotantes.php?probar=1" method="POST" onsubmit="return dobValidate('date')">
				<span class="contact100-form-title">
                                    Modificar votante <p><?php   echo  $_SESSION['datosVotante']['nombre'] ." ". $_SESSION['datosVotante']['apellidos'];   ?></p>
				</span>
				...
				<div class="wrap-input100 validate-input" data-validate = "Pon tus Apellidos">
					...
					<span class="focus-input100"></span>
                            ...
                            <center><p>____________</p></center>
	...
	<div id="dropDownSelect1"></div>
      ...
      //_______________________________________________________   
        ...
        <div class="table100 ver1 m-b-110">
            ...
            <br><center><h1> Datos Votante <?php   echo  $_SESSION['datosVotante']['nombre'] ." ". $_SESSION['datosVotante']['apellidos'];   ?><b><?php 
       
     ?>
           
                </h1></center><br><br><div class="wrap-input100 validate-input" >
   ...
   echo $_SESSION['visionVot']['nif'] ?> </td><td class="column100 column2" data-column="column2"> <?php
    echo $_SESSION['visionVot']['nombre'] ?> </td><td class="column100 column3" data-column="column3"> <?php
      echo $_SESSION['visionVot']['apellidos'] ?> </td><td class="column100 column4" data-column="column4"> <?php
        echo $_SESSION['visionVot']['fechaNac'] ?> </td><td class="column100 column5" data-column="column5"> <?php
          echo $_SESSION['visionVot']['domicilio'] ?> </td><td class="column100 column6" data-column="column6"> <?php
           
              echo $_SESSION['visionVot']['rol'] ?> </td><td class="column100 column6" data-column="column6"> <?php
